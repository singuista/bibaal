...
class FlexboxPage extends Component {
	/**
	 * Constructor
	...
	**/
	componentDidCatch(errorString, errorInfo) {
		console.error('Error in FlexboxPage.js Page === ', errorString)
		console.error('FlexboxPage.js error stack === ', errorInfo)
	}
	...
	**/
	componentWillMount() {
		emitter.on('FlexboxPageEvent', param => {
	...
	**/
	componentDidMount() {
		emitter.emit('FlexboxPageEvent', {
			name: 'Flexbox Page Emitter',
			thisIs: false,
		...
		return(
			<DocumentTitle title="Flexbox Page">
				<section className="FlexboxPage">
					<h1 className="text-center">Flexbox layout example</h1>
