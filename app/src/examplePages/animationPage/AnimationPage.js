...
class AnimationPage extends React.Component {
	...
	**/
	componentDidCatch(errorString, errorInfo) {
		console.error('Error in AnimationPage.js Page === ', errorString)
		console.error('AnimationPage.js error stack === ', errorInfo)
	}
	...
	**/
	componentWillMount() {
		emitter.on('AnimationPageEvent', param => {
	...
	**/
	componentDidMount() {
		emitter.emit('AnimationPageEvent', {
			name: 'Animation Page Emitter',
			thisIs: false,
			message: 'This is an event emitter example'
		})
	}
	...
	render() {
		return (
			<DocumentTitle title="CSS Animations!!">
				<section id="Animation" className="text-center"  itemScope="itemscope" itemType="http://schema.org/VisualArtwork">
